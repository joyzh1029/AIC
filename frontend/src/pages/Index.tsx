    ...
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <NavigationMenu>
            <NavigationMenuList className="hidden md:flex gap-6">
              <a href="#services" className="text-sm hover:text-primary">서비스소개</a>
              <a href="#features" className="text-sm hover:text-primary">교감방식</a>
              <a href="#contact" className="text-sm hover:text-primary">고객지원</a>
            </NavigationMenuList>
          </NavigationMenu>
        </div>
      </header>
      ...
      <section className="container mx-auto py-16 px-4 text-center">
        <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-sky-50 text-sky-500 mb-10">
          ...
          <span className="text-sm font-medium tracking-wide">나만의AI친구</span>
        </div>
        ...
        <p className="text-gray-600 max-w-2xl mx-auto mb-12 text-lg leading-relaxed">
          ...
          <span className="text-amber-400 font-medium">심리적지지</span> 를 느껴보세요.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          ...
          <Button variant="outline" className="border-sky-200 text-sky-500 hover:bg-sky-50 px-10 py-6 text-lg font-medium tracking-wide rounded-xl">
            서비스 소개
          </Button>
        </div>
      ...
      <section id="features" className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-6 tracking-tight">서비스 특징</h2>
