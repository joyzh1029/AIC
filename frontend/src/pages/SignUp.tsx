  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      if (error.code === "auth/requires-recent-login") {
        alert(
          "보안을 위해 다시 로그인 후 계정 삭제가 가능합니다. 로그아웃 후 다시 로그인 해주세요."
        );
      } else {
      ...
      <div className="hidden md:flex md:w-1/2 bg-sky-100 items-center justify-center p-8">
        <div className="max-w-md text-center space-y-6">
          ...
          <p className="text-gray-600">
            성장기에 누구나 가졌던 상상 속 친구
            <br />
            이제 AI로 만나보세요
          </p>
          <p className="text-sky-500 text-sm">© AIC 2025</p>
        </div>
      </div>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-4 md:p-8">
        <div className="w-full max-w-md space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              type="submit"
              className="w-full py-3 bg-blue-400 hover:bg-blue-500 text-white rounded-lg font-medium"
            >
              로그인
            </Button>
            ...
            <div className="text-center text-gray-500 text-sm">
              ...
              <div className="mt-4 flex justify-center space-x-4">
                <button
                  className="w-12 h-12 flex items-center justify-center rounded-lg border border-gray-300 hover:border-gray-400 p-2"
