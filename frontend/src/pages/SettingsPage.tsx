...
import { ChevronLeft, ChevronRight, Settings, Bell, Database, Info, Edit, Volume2, MapPin, Shield, FileText, HelpCircle, Footprints } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-md mx-auto p-4 space-y-8">
        ...
        <div className="bg-white rounded-lg p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Avatar className="h-12 w-12">
              <AvatarImage src="/lovable-uploads/468b3bb5-ece7-4600-8db8-f401827a591a.png" alt="김유진" />
        ...
        <div className="text-center py-8 space-y-2">
          ...
          <p className="text-xs text-gray-400">© AIC 2025. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
