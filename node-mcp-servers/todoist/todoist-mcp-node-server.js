...
app.get('/', (req, res) => {
  res.json({
    message: 'Todoist MCP Server is running with an HTTP interface.',
    http_port: HTTP_PORT,
    stdio_status: 'Also configured for stdio communication.'
  });
});

app.listen(HTTP_PORT, () => {
  console.log(`Todoist MCP Server HTTP interface running on http://localhost:${HTTP_PORT}`);
});
